  ...
  return (
    <div className='flex mt-32 ml-10 mr-10 justify-around items-center'>
        ...
        <div className='mr-44'>
            ...
            <VerifiedUserIcon />
            <p className='text-base font-medium text-gray-600'>Safe Purchase at 100%</p>
            </div>
            <div className='flex mt-16 space-x-4'>
            <LocalMallIcon />
            <p className='text-base font-medium text-gray-600'>Over 90.000 Products in the catalog</p>
            </div>
            <div className='flex mt-16 ml-1 space-x-4'>
            <LocalShippingIcon />
            <p className='text-base font-medium text-gray-600'>Guaranteed Delivery in 48/72 Hours</p>
            </div>
            <div className='flex mt-16 -ml-8 space-x-4'>
            <AssignmentIcon />
            <p className='text-base font-medium text-gray-600'>Beauty Consultant Dedicated</p>
            </div>
